var diagram = (function () {
	...
	*/
	...
	var set_active_document_1 = set_active_document;

	var get_documents_1 = get_documents;
	var update_document_1 = update_document;
	var get_document_content_1 = get_document_content;
	var get_node_names_1 = get_node_names;

	var get_node_attr_1 = get_node_attr;
	var update_node_attr_1 = update_node_attr;
	var json_update_yaml_1 = json_update_yaml;

	var get_edges_1 = get_edges;
	var get_node_attrs_1 = get_node_attrs;
	...
	var model = {
		...
		get_documents: get_documents_1,
		update_document: update_document_1,
		get_document_content: get_document_content_1,
		get_node_names: get_node_names_1,
		get_node_attr: get_node_attr_1,
		update_node_attr: update_node_attr_1,
		json_update_yaml: json_update_yaml_1,
		get_edges: get_edges_1,
		get_node_attrs: get_node_attrs_1
	};
	...
	*/
	...
	var add_nodes_1 = add_nodes;
	var clear_nodes_1 = clear_nodes;

	var node_1 = {
		add_nodes: add_nodes_1,
	...
	var add_edges_1 = add_edges;
	var clear_edges_1 = clear_edges;

	var edges = {
		add_edges: add_edges_1,
		clear_edges: clear_edges_1
	};
	...
	function node_moved() {
	  //update model
	  var nodes = model.get_node_names();
	  for (let n of nodes) {
	    let e = document.getElementById(n);
	    model.update_node_attr(n, 'left', e.style.left);
	    model.update_node_attr(n, 'top', e.style.top);
	  }
	  model.json_update_yaml();
	  if (model.get_active_document() === 'diagram') {
	...
	function update_dropdown() {
	  ...
	  opt.text = 'diagram';
	  opt.value = 'diagram';
	  var names = model.get_node_names();
	  for (const el of names) {
	  ...
	  dropdown.value = model.get_active_document;
	  ...
	  dropdown.onchange = function () {
	    ...
	    source.setValue(model.get_document_content(n));
	    model.set_active_document(n);
	  };
	}
	...
	function node_selected(p) {
	  ...
	  dropdown.value = p.id;
	  source.setOption('mode', 'markdown');
	  source.setValue(model.get_document_content(p.id));
	}
	...
	function update_view() {
	  ...
	  if (window.j) {
	    window.j.reset();
	    node_1.add_nodes(model);
	    edges.add_edges(model.get_edges());
	  }
	}
	...
	function document_changed() {
	  var str, name;
	  str = source.getValue();
	  name = model.get_active_document();
	  if (name === 'diagram') {
	    model.update_document(name, 'yaml', str);
	    update_dropdown();
	    dropdown.value = 'diagram';
	  } else {
	    model.update_document(name, 'markdown', str);
	  }
	  update_view();
	  //update_permlink();
	}
