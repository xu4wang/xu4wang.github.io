var diagram = (function () {
  ...
  function on$1(eventName, cb, dep = []) {
  ...
  var get_attr_1 = get_attr;
  var update_attr_1 = update_attr;
  var get_attrs_1 = get_attrs;
  var get_common_attr_1 = get_common_attr;

  var get_all_names_1 = get_all_names;
  var on = state.on;
  var reset_listener = state.reset_listener;
  ...
  *****************/
  ...
  var model = {
  	...
  	get_impacted_document: get_impacted_document_1,
  	...
  	get_attr: get_attr_1,
  	update_attr: update_attr_1,
  	get_attrs: get_attrs_1,
  	get_common_attr: get_common_attr_1,
  	get_all_names: get_all_names_1,
  	on: on,
  ...
  */
  ...
  function document_changed() {
    ...
    model.update_document(name, str);
  }
