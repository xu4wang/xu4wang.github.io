import { l as log$1, an as decodeEntities, ap as dedent } from "../app.6a86UdOJ.js";
const emptyOptions = {};
...
function markdownLineEnding$5(code) {
...
function markdownLineEnding$4(code) {
  return code !== null && code < -2;
}
...
function tokenizeBlankLine(effects, ok, nok) {
  return start;
  function start(code) {
    return markdownSpace$2(code) ? factorySpace(effects, after, "linePrefix")(code) : after(code);
  }
  function after(code) {
    return code === null || markdownLineEnding$4(code) ? ok(code) : nok(code);
  }
}
const blockQuote = {
  name: "blockQuote",
...
function tokenizeCodeFenced(effects, ok, nok) {
  ...
  function sequenceOpen(code) {
    ...
    return markdownSpace$2(code) ? factorySpace(effects, infoBefore, "whitespace")(code) : infoBefore(code);
  }
  ...
  function contentStart(code) {
    return initialPrefix > 0 && markdownSpace$2(code) ? factorySpace(
      effects,
      beforeContentChunk,
      "linePrefix",
      initialPrefix + 1
  ...
  function tokenizeCloseStart(effects2, ok2, nok2) {
    ...
    function start2(code) {
      ...
      return markdownSpace$2(code) ? factorySpace(
        effects2,
        beforeSequenceClose,
        "linePrefix",
        self.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4
    ...
    function sequenceClose(code) {
      ...
      if (size >= sizeOpen) {
        ...
        return markdownSpace$2(code) ? factorySpace(effects2, sequenceCloseAfter, "whitespace")(code) : sequenceCloseAfter(code);
      }
      return nok2(code);
    }
...
function tokenizeFurtherStart(effects, ok, nok) {
  ...
  function afterPrefix(code) {
    const tail = self.events[self.events.length - 1];
    return tail && tail[1].type === "linePrefix" && tail[2].sliceSerialize(tail[1], true).length >= 4 ? ok(code) : markdownLineEnding$4(code) ? furtherStart2(code) : nok(code);
  }
}
const codeText = {
  name: "codeText",
...
function tokenizeCodeText(effects, ok, nok) {
  ...
  function data(code) {
    if (code === null || code === 32 || code === 96 || markdownLineEnding$4(code)) {
...
function factoryLabel(effects, ok, nok, type, markerType, stringType) {
  ...
  function labelInside(code) {
    if (code === null || code === 91 || code === 93 || markdownLineEnding$2(code) || size++ > 999) {
      effects.exit("chunkString");
      return atBreak(code);
    }
    effects.consume(code);
...
function tokenizeDefinition(effects, ok, nok) {
  ...
  function after(code) {
    return markdownSpace$2(code) ? factorySpace(effects, afterWhitespace, "whitespace")(code) : afterWhitespace(code);
  }
...
function tokenizeTitleBefore(effects, ok, nok) {
  ...
  function titleAfter(code) {
    return markdownSpace$2(code) ? factorySpace(effects, titleAfterOptionalWhitespace, "whitespace")(code) : titleAfterOptionalWhitespace(code);
  }
...
function tokenizeHtmlFlow(effects, ok, nok) {
  ...
  function completeAttributeValueQuotedAfter(code) {
    if (code === 47 || code === 62 || markdownSpace$2(code)) {
      return completeAttributeNameBefore(code);
    }
    return nok(code);
  }
  ...
  function continuation(code) {
    ...
    if (markdownLineEnding$4(code) && (marker === 6 || marker === 7)) {
...
function tokenizeThematicBreak(effects, ok, nok) {
  ...
  function atBreak(code) {
    ...
    if (size >= 3 && (code === null || markdownLineEnding$4(code))) {
  ...
  function sequence(code) {
    ...
    return markdownSpace$2(code) ? factorySpace(effects, atBreak, "whitespace")(code) : atBreak(code);
  }
}
const list = {
  name: "list",
...
function tokenizeListContinuation(effects, ok, nok) {
  ...
  function notBlank(code) {
    if (self.containerState.furtherBlankLines || !markdownSpace$2(code)) {
...
function tokenizeListItemPrefixWhitespace(effects, ok, nok) {
  ...
  function afterPrefix(code) {
    const tail = self.events[self.events.length - 1];
    return !markdownSpace$2(code) && tail && tail[1].type === "listItemPrefixWhitespace" ? ok(code) : nok(code);
  }
}
...
function tokenizeSetextUnderline(effects, ok, nok) {
  ...
  function inside(code) {
    ...
    return markdownSpace$2(code) ? factorySpace(effects, after, "lineSuffix")(code) : after(code);
  }
  function after(code) {
    if (code === null || markdownLineEnding$4(code)) {
