import { a0 as __vitePreload, h as ref, y as watch, an as unrefElement, ao as tryOnScopeDispose, d as defineComponent, G as shallowRef, ap as computedAsync, g as computed, aq as useSessionStorage, ar as useLocalStorage, z as watchEffect, as as watchDebounced, j as onMounted, M as nextTick, Z as onKeyStroke, J as useRouter, X as reactify, Y as toRef, at as useEventListener, a1 as useScrollLock, v as inBrowser, au as onBeforeUnmount, o as openBlock, b as createBlock, k as createBaseVNode, a5 as withModifiers, m as unref, K as withDirectives, av as vModelText, aw as isRef, c as createElementBlock, n as normalizeClass, e as createCommentVNode, E as renderList, F as Fragment, a as createTextVNode, t as toDisplayString, ax as Teleport, p as pushScopeId, q as popScopeId, ay as markRaw, az as createApp, ac as dataSymbol, ai as pathToFile, _ as _export_sfc } from "./framework.XmXKRmb4.js";
import { u as useData, c as createTranslate, L as LRUCache } from "./theme.Lyvw_tRM.js";
const localSearchIndex = { "root": () => __vitePreload(() => import("./@localSearchIndexroot.7Da3PvD5.js"), true ? __vite__mapDeps([]) : void 0) };
/*!
* tabbable 6.2.0
...
const _withScopeId = (n) => (pushScopeId("data-v-1289454d"), n = n(), popScopeId(), n);
...
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1289454d"]]);
export {
