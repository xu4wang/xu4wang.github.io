...
智能合约目前一般用solidity编写，是以太坊应用。语法类似JavaScript，网上也有不少开发的入门教程。
...
主要解决资产认证的问题。 目前现实世界都是中心化的组织做资产认证。例如国家认证你的房产证， 游戏公司认证你在游戏中所有的装备。 用NFT是一种去中心化的方式， 资产可以被认证，被交易。
...
NFT基于智能合约技术，所以可以设置资产的转移价格，甚至可以在发布时候，设置每一次资产转移交易，都给内容的创作者付一定比例的版税。

NFT是对内容的认证。所以参与NFT需要有：
- 钱包（账户，所有权人）
...
它们类似股市、零售商店或电子商务对传统经济的影响一样。 
- 在股市可以买卖传统股票，在Uniswap可以交易加密货币（不需要通过Coinbase或 Gemini，币安这样的中心化中介）。 
...
每一个账户本质上由非对称密钥系统进行保护。 公钥用来公开接收信息， 私钥用来授权签名。
...
- mint 铸造，就是在区块链上记载了一个token的ID和其拥有者的地址。
- metaverse 元宇宙: 不同机构有不同定义，有人将其看作web3的终极版本。 也有人仅将其看作增强虚拟现实。

## 8. FAQ

### 8.1. 美国为什么能制裁俄罗斯的比特币投资？
...
原因是
- conbase是受美国监管的中心化的交易所，做KYC，可以阻隔俄罗斯用户
